    ...
    <div className="bg-white text-gray-800 overflow-x-hidden">
      ...
      <div className="px-6 md:px-16 py-12 ">
        ...
        <div className="mb-12">
          ...
          <p className="mb-4">
            At KP Automation, we're dedicated to shaping the future of Industrial Automation . This course introduces the basics of automation systems used in modern IndustrialAutomation including sensors, actuators, controllers, and integration strategies.
          </p>
